...
urlpatterns = [
    ...
    # URL para cadastrar a meta de leitura
    path('metas/nova/', views.cadastrar_meta, name='cadastrar_meta'),
    # URL placeholder para redirecionar
    path('metas/minhas/', views.minhas_metas, name='minhas_metas'),
    path('marcar_lido/<int:livro_id>/', views.marcar_livro_lido, name='marcar_livro_lido'),
